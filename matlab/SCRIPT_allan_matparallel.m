...
% Our bag information
mat_path = '~/Dataset/realsense_d455/imu_allan_calib/imu_allan.mat';
...
fprintf('saving to: %s\n',filename);
save([pathstr,'/',filename],'update_rate','ts_imua','ts_imuw','tau','taumax','results_ax','results_ay','results_az','results_wx','results_wy','results_wz')
fprintf('done saving!\n');
